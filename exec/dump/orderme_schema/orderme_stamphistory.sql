...
--
-- Table structure for table `stamphistory`
--
...
CREATE TABLE `stamphistory` (
  ...
  `stamp_id` int NOT NULL COMMENT '스탬프 ID',
  `order_id` int DEFAULT NULL COMMENT '주문 ID',
  `action_type` varchar(20) NOT NULL COMMENT '액션 타입 (EARN/USE)',
  `stamp_count` int NOT NULL COMMENT '스탬프 개수',
  `policy_id` int DEFAULT NULL COMMENT '적용된 정책 ID',
